...
TheEighth is an Angular 20 application for managing tabletop RPG campaigns. It uses **Supabase** (PostgreSQL + Auth + Storage + Realtime) as the backend and supports multi-tenant deployments for different game systems (e.g. The Dark Eye 5th edition, custom systems).
